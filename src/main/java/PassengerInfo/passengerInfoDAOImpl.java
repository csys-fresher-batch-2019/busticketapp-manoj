...
public class passengerInfoDAOImpl implements passengerInfoDAO {
	public int insertPassengerInfo(passengerInfo a) throws Exception {
		...
		String sql2="update seat_availability set available_seats=available_seats-"+a.noOfTickets+" where bus_id=?";
		...
		String sql4 = "insert into payment_status(user_id,bus_id,booking_id,total_price)values("+a.userId+","+a.busId+","+bId+","+totalPrice+")";
	...
	public ArrayList<passengerInfo> BookingDetails(int bookingId) throws Exception{
		...
		ResultSet rows=pst5.executeQuery();
	...
	public void cancelBooking(int bookingId) throws Exception{
	 ...
	 public boolean validateBookingId(int bookingId) throws Exception{
		 ...
		 Connection con = TestConnection.connection();
			...
			PreparedStatement smt = con.prepareStatement(bId);
	 ...
	 public boolean validateBusId(int busId) throws Exception {
			...
			PreparedStatement smt9 = con.prepareStatement(bus);
			smt9.setInt(1, busId);
